...
/**
 Reflection methods
 */
final internal class EVReflection {
    ...
    */
    internal class func fromDictionary(dictionary:NSDictionary, anyobjectTypeString: String) -> NSObject? {
    ...
    /**
     ...
     :returns: The object that is created from the dictionary
     */
    internal class func setPropertiesfromDictionary<T where T:NSObject>(dictionary:NSDictionary, anyObject: T) -> T {
    ...
    internal class func getValue(fromObject: NSObject, key:String) -> NSObject? {
     ...
     */
    internal class func toDictionary(theObject: NSObject, performKeyCleanup:Bool = false) -> (NSDictionary, Dictionary<String,String>) {
    ...
    */
    internal class func dictionaryFromJson(json: String?) -> Dictionary<String, AnyObject> {
     ...
     */
    internal class func arrayFromJson<T>(type:T, json: String?) -> [T] {
        var result = [T]()
        if json == nil {
            return result
        }
     ...
     */
    internal class func toJsonString(theObject: NSObject, performKeyCleanup:Bool = true) -> String {
    ...
    :returns: Nothing
    */
    internal class func logObject(theObject: NSObject) {
    ...
    /**
     ...
     :returns: The string representation of the object
     */
    internal class func description(theObject: NSObject) -> String {
     ...
     */
    internal class func hashValue(theObject: NSObject) -> Int {
        let (hasKeys, _) = toDictionary(theObject, performKeyCleanup:false)
    ...
    /**
     ...
     :returns: Nothing
     */
    internal class func encodeWithCoder(theObject: NSObject, aCoder: NSCoder) {
        let (hasKeys, _) = toDictionary(theObject, performKeyCleanup:false)
        for (key, value) in hasKeys {
     ...
     */
    internal class func decodeObjectWithCoder(theObject: NSObject, aDecoder: NSCoder) {
        let (hasKeys, _) = toDictionary(theObject, performKeyCleanup:false)
     ...
     */
    internal class func areEqual(lhs: NSObject, rhs: NSObject) -> Bool {
     ...
     */
    internal class func dictionariesAreEqual(lhsdict: NSDictionary, rhsdict: NSDictionary) -> Bool {
    ...
    */
    internal class func getCleanAppName(forObject: NSObject? = nil)-> String {
    ...
    /**
     ...
     :returns: Nothing
     */
    internal class func setBundleIdentifier(forClass: AnyClass) {
     ...
     */
    internal class func setDateFormatter(formatter: NSDateFormatter?) {
     ...
     */
    internal class func swiftClassTypeFromString(className: String) -> AnyClass! {
    ...
    /**
     ...
     :returns: The Class type
     */
    internal class func swiftClassFromString(className: String) -> NSObject? {
     ...
     */
    internal class func swiftStringFromClass(theObject: NSObject) -> String! {
     ...
     */
    internal class func valueForAny(parentObject:Any? = nil, key:String? = nil, anyValue: Any) -> (value: AnyObject, type: String, isObject: Bool) {
